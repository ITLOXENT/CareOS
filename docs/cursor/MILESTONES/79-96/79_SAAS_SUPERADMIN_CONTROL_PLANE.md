# 79_SAAS_SUPERADMIN_CONTROL_PLANE

## Cursor Agent Prompt

```text
Implement Saas Superadmin Control Plane.

Goals:
- Build the SaaS control plane (platform admin) for tenant lifecycle management, org provisioning, domain mapping, user impersonation (audited), and system health.
