# 85_DATA_EXPORT_DSAR_AND_ADMIN_PRIVACY_TOOLS

## Cursor Agent Prompt

```text
Implement Data Export Dsar And Admin Privacy Tools.

Goals:
- GDPR tooling: DSAR export, account deletion workflow, data portability, and consent logs.
