# 81_TENANT_ONBOARDING_AND_SELF_SERVICE_SIGNUP

## Cursor Agent Prompt

```text
Implement Tenant Onboarding And Self Service Signup.

Goals:
- Self-serve signup, org creation wizard, invite flows, initial role bootstrap, and secure email verification.
