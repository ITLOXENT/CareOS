# 96_GA_RELEASE_CHECKLIST_AND_HARDENING

## Cursor Agent Prompt

```text
Implement Ga Release Checklist And Hardening.

Goals:
- Final GA hardening: performance budgets, threat model review, pen-test fixes, and release checklist.
