# 94_DATA_WAREHOUSE_ANALYTICS_AND_REPORT_EXPORTS

## Cursor Agent Prompt

```text
Implement Data Warehouse Analytics And Report Exports.

Goals:
- Enterprise analytics exports, scheduled reports, warehouse-friendly events, and BI connectors.
