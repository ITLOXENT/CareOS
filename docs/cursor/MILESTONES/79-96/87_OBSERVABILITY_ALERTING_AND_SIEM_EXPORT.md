# 87_OBSERVABILITY_ALERTING_AND_SIEM_EXPORT

## Cursor Agent Prompt

```text
Implement Observability Alerting And Siem Export.

Goals:
- Structured logs, metrics, tracing, alerting, and optional SIEM export feeds.
