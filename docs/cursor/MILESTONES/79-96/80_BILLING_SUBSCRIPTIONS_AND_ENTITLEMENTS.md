# 80_BILLING_SUBSCRIPTIONS_AND_ENTITLEMENTS

## Cursor Agent Prompt

```text
Implement Billing Subscriptions And Entitlements.

Goals:
- Implement subscription billing (Stripe), plans, seats, feature flags/entitlements, metering hooks, and invoice webhooks.
