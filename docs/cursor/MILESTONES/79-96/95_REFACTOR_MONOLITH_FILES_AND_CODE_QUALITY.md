# 95_REFACTOR_MONOLITH_FILES_AND_CODE_QUALITY

## Cursor Agent Prompt

```text
Implement Refactor Monolith Files And Code Quality.

Goals:
- Split oversized modules (>400 LOC) into maintainable packages without breaking contracts.
