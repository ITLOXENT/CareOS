# 92_MOBILE_RELEASE_PIPELINE_AND_MDM_OPTIONS

## Cursor Agent Prompt

```text
Implement Mobile Release Pipeline And Mdm Options.

Goals:
- Mobile release process, environment separation, signing, and enterprise distribution options.
