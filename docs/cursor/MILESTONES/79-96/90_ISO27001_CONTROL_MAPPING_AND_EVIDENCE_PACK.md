# 90_ISO27001_CONTROL_MAPPING_AND_EVIDENCE_PACK

## Cursor Agent Prompt

```text
Implement Iso27001 Control Mapping And Evidence Pack.

Goals:
- Map controls to system features, generate evidence artifacts, and implement required operational checks.
