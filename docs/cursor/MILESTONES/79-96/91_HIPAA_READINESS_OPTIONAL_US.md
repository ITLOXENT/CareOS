# 91_HIPAA_READINESS_OPTIONAL_US

## Cursor Agent Prompt

```text
Implement Hipaa Readiness Optional Us.

Goals:
- Optional HIPAA readiness track: BAA-friendly architecture, audit logging, and access safeguards.
