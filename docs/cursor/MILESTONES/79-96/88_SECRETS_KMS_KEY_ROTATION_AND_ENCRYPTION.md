# 88_SECRETS_KMS_KEY_ROTATION_AND_ENCRYPTION

## Cursor Agent Prompt

```text
Implement Secrets Kms Key Rotation And Encryption.

Goals:
- Production-grade secrets management, key rotation, envelope encryption, and secure audit trails.
