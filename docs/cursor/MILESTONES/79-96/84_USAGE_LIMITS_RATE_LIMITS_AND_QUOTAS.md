# 84_USAGE_LIMITS_RATE_LIMITS_AND_QUOTAS

## Cursor Agent Prompt

```text
Implement Usage Limits Rate Limits And Quotas.

Goals:
- Enforce API quotas and per-plan limits, org-level throttling, and safe error responses.
