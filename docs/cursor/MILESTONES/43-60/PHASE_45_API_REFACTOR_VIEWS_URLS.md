...
- Phase 45 deliverables are implemented.
...
Backend
- Split `apps/api/core/views.py` into `apps/api/core/views/` package:
  - auth.py, me.py, episodes.py, inbox.py, orgs.py, evidence.py, admin.py (as applicable)
- Create/normalize `apps/api/core/urls.py` and route modules explicitly.
- Keep URL paths stable; update OpenAPI if required.
