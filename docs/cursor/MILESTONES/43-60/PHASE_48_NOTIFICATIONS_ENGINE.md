...
- Phase 48 deliverables are implemented.
...
Backend
- Notification model (tenant-scoped) and API:
  - GET /notifications
  - POST /notifications/{id}/read
- Event sources:
  - Episode transition -> notify assignee + watchers (if any)
  - WorkItem assigned -> notify assignee
Frontend (web-admin)
- Notifications page shows unread/read, supports mark-as-read.
