...
- Phase 51 deliverables are implemented.
...
Backend
- Admin endpoints:
  - Manage staff users in org (list/invite/disable)
  - Role assignment
  - Org settings CRUD (safe subset)
  - API keys for integrations (rotate/revoke)
Frontend
- Admin Settings pages become functional (not placeholders).
Tests
- RBAC coverage for admin-only operations.
